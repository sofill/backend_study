...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    // => 또한 DBMS 의 연결작업을 수행한다.
    // => 드라이버 구현체는 Driver 매니저가 관리한다.
    // => 따라서 접속할 DBMS 의 Driver 구현체를 생성하여 DriverManager 에게 등록해야 한다.
    //
    // DriverManager
    // => java.sql.Driver 구현 객체를 관리하는 일을 한다.
    // DBMS 연결 요청이 들어오면 해당 DBMS 의 Driver 구현체를 찾아 작업을 위임한다.
    //
    //
    ...
    try {
      ...
      // DriverManager에 등록된 Driver 인스턴스를 확인해 보자!
