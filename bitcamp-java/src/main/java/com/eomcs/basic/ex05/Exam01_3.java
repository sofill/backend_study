...
public class Exam01_3 {
    public static void main(String[] args) {
       ...
       byte b;   
        ...
        // -  byte 변수에 저장할 수 있다면 허락한다!(크기가 넘치지 않는다면)

        b = 5 + 6; // OK! -> 리터럴과 리터럴이기때문에 효용성을 위해 컴파일러가 더해버리는 것.
        ...
        //  "그래서 byte나 short의 연산 단위가 기본으로 4바이트다."
        //
        ...
        s3 = s2; // OK
        //s3 = s1 + s2; // 컴파일 오류!!
        int s4 = s1 + s2; // OK (당연하지. 더 큰 int 에 넣는거니까)
