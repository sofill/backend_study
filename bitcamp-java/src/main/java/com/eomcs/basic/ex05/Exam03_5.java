...
public class Exam03_5 {
    public static void main(String[] args) {
        ...
        // 정수 값에 대해서는 &&와 ||, !을 사용할 수 없다. (앤드 오아 낫)
        //System.out.println(a && b); // 컴파일 오류!
        //System.out.println(a || b); // 컴파일 오류!
        //System.out.println(!a); // 컴파일 오류!

        // 그러나 &, |, ^, ~는 사용할 수 있다.★★ (이게 비트연산자이다.)
        // => 각 비트 단위로 연산을 수행한다.
        // => 1은 true, 0은 false라고 간주하고 계산한다.
        // => 출력 결과도 정수이다.

        System.out.println(a & b); // &는 둘 다 1일때만 1 ★
        ...
        System.out.println(a ^ b); // 둘이 서로 다를 때만 1 ★
        // a = 0000 0000 0000 0000 0000 0000 0110 1100
        // b = 0000 0000 0000 0000 0000 0000 0101 0101
        // --------------------------------------------
        ...
        System.out.println(~a); // 맨 앞에 1이 붙어서 -가 됨★
        // a = 0000 0000 0000 0000 0000 0000 0110 1100
        // --------------------------------------------
