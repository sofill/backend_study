...
public class Exam01_43 {
  public static void main(String[] args) {
    ...
    // => 즉, 4바이트 float 부동소수점을 8바이트 double 부동소수점 변수에 저장할 때
    //       왜곡된 값이 들어갈 수 있다. 
    // => float을 double 변수에 넣을 때 왜곡이 발생하기 떄문에
    //       가능한 double 변수로 값을 바꾼 다음에 연산을 수행하라.
    //       더 좋은 것은, 처음부터 double 변수를 사용하는 것이다!★
    ...
    // 이유? 이것도 똑같이 IEEE 754의 이진수 변환 문제때문. 고민하지 말라~!
    // 어떻게 처리할 건데?
    // 맨 뒤에붙는 극한의 작은 수는 그냥 잘라 버린다. 
  }
}
