...
public class Exam02_2 {
    public static void main(String[] args) {
        ...
        //   컴퓨터에서 발생하는 문제이다. (C나 python 등 전부 해당)
        System.out.println(d1 + d2); 
        // 987.6543 + 1.111111 = 988.7654110000001 ★
        // => 결과 뒤에 극소수의 값이 붙는다.
        // => 그래서 부동소수점의 비교를 대충 막 다루지 말라! ★
        ...
        // d1 + d2와 달리 x + y의 계산 결과는 극소수의 값이 붙지 않는다. 
        // 234.765411 + 754.0 = 988.765411

        // IEEE 754 의 변환 공식에 따라 발생되는 이런 문제를
        ...
        double EPSILON = 0.00001; // 개발자가 직접 프로그램 짜주라는 말!
