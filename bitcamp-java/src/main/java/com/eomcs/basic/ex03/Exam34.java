...
public class Exam34 {
  public static void main(String[] args) {
    ...
    System.out.println(31415926.53589793); // OK! (3.141592653589793E7 가 나오는데 E7는 10의 7승!)
    System.out.println(314159265358979.3); // OK!

    // 16자리의 경우 일부 부동소수점의 값이 제대로 저장되지 않는다.
    System.out.println(914159265358979.3); // 값이 구겨진다. 9.141592653589792E14 -> 끝이 2로 구겨진다. 
    ...
    System.out.println(7 * 0.1); // 0.7000000000000001 이라고 나온다. 
