...
// 한 개 파일이 아니라 여러 개 파일을 직접 컴파일 하는 방법 (이클립스 없이 직접 컴파일 할 때의 번거로움)
...
//   컴파일할 때 Score 클래스 정보가 필요하다. Score는 도대체 어디 있냐고...
...
// 
// 방법2) Score 클래스의 소스 파일이 있다면 "소스 파일의 위치"를 알려줘라.  
//   > javac -encoding UTF-8 -d bin/main -sourcepath src/main/java src/main/java/com/eomcs/oop/ex01/Exam0410.java
//          
// 언제 이렇게 해야 하는가?
