...
public class Exam0360 {
  ...
  Runner createRunner(final String name) {
    // Exam0360 객체 주소를 받는 내장변수 this가 있다.
    //
    class A implements Runner {
      // 컴파일러는 바깥 클래스의 객체 주소를 받을 필드를 추가한다.
      // 또한 바깥 클래스의 객체 주소를 받는 생성자를 추가한다.
      // Exam0360 outer; - 컴파일러가 추가한 객체 주소를 받을 필드
      // public A(Exam0360 obj) { outer = obj } - 컴파일러가 추가한 생성자
       ...
       *
       * public A(Exam0360 obj, String str) { outer = obj; name = str; }
       */
      ...
      public void run() {
        ...
        // 위 문장은 로컬 클래스의 필드를 사용하는 문장으로 바꾼다.
