...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    // 이처럼 여러 스레드가 동시에 실행될 때 문제를 일으키는 코드를
    ...
    //
    // 세마포어(n); semaphore
    // => 크리티컬 섹션에 진입할 수 있는 스레드의 수를 지정하는 것.
    //    세마포어(2) : 그 크리티컬 섹션에 2개의 스레드가 접근 가능하다.는 뜻.
    // => 자바에서는 세마포어를 지원하지 않는다.
    // => 개발자가 직접 처리해야 한다.
    //
    // 뮤텍스; mutex(mutual exclusion, 상호배제)
    // => 한 번에 오직 한 개의 스레드만이 크리티컬 섹션에 접근할 수 있다.
    // => 예) 선풍기 풍량세기 버튼(풍량2 누르면 풍량1이 튕겨짐), 라디오 채널, TV 채널 등
    // => semaphore(1)이라고도 부른다. 자바는 mutex(semaphore(1))만 지원한다.
